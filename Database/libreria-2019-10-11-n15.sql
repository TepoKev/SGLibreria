...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2019 a las 23:36:41
...
CREATE TABLE `detalleventa` (
  ...
  `IdVenta` int(11) NOT NULL,
  `Cantidad` int(11) NOT NULL,
  `IdProductoPrecioVenta` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `oferta` (`Id`, `Descuento`, `FechaInicio`, `FechaFin`, `Estado`) VALUES
(29, 0, '2019-10-03 00:00:00', '2019-10-02 00:00:00', 0),
(30, 14, '2019-10-03 00:00:00', '2019-10-02 00:00:00', 1),
(31, 15, '2019-10-03 00:00:00', '2019-10-02 00:00:00', 0);
...
INSERT INTO `producto` (`Id`, `Codigo`, `IdCategoria`, `IdImagen`, `Nombre`, `Marca`, `Descripcion`, `StockMinimo`, `Estado`, `FechaVencimiento`) VALUES
(1, NULL, 3, 1, 'Borrador', 'Facela', 'color blanco, 4cm*2cm', 10, 1, NULL),
(2, NULL, 2, 2, 'Colores', 'Facela', 'Caja con 12 colores diferentes', 6, 1, NULL),
(3, NULL, 1, 3, 'Cuaderno', 'Scribe', '70 paginas', 12, 1, NULL),
(4, NULL, 3, 4, 'Lapicero', 'Big', 'color azul', 25, 1, NULL),
(5, NULL, 3, 5, 'Zacapunta', 'Facela', 'zacapunta color azul', 20, 1, NULL);
...
ALTER TABLE `detalleventa`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IdVenta` (`IdVenta`),
  ADD KEY `IdProductoPrecioVenta` (`IdProductoPrecioVenta`);
...
ALTER TABLE `detalleventa`
  ...
  ADD CONSTRAINT `detalleventa_ibfk_2` FOREIGN KEY (`IdProductoPrecioVenta`) REFERENCES `productoprecioventa` (`Id`);
...
--
-- Filtros para la tabla `productoprecioventa`
--
ALTER TABLE `productoprecioventa`
  ADD CONSTRAINT `productoprecioventa_ibfk_1` FOREIGN KEY (`IdProducto`) REFERENCES `producto` (`Id`);
