...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2019 a las 21:16:34
...
INSERT INTO `detallecompra` (`Id`, `IdCompra`, `Cantidad`, `IdPrecioCompra`) VALUES
(1, 1, 50, 1),
(2, 1, 10, 2),
(3, 2, 30, 3),
(4, 2, 100, 4),
...
--
-- Volcado de datos para la tabla `preciocompra`
--

INSERT INTO `preciocompra` (`Id`, `Fecha`, `Valor`, `IdProducto`) VALUES
(1, '2019-10-01', '0.80', 1),
(2, '2019-10-01', '0.75', 2),
(3, '2019-06-12', '1.00', 3),
(4, '2019-06-06', '0.15', 4),
...
(1, NULL, 1, 16, 'Cuadernos', 3, 'Cuaderno rayado', 16, 0, '2020-02-21'),
...
INSERT INTO `servicio` (`Id`, `IdImagen`, `Nombre`, `Estado`) VALUES
(1, NULL, 'Copias', 1),
(2, NULL, 'Impresiones', 1);
